...
class FacebookResponseExceptionTest extends \Mockery\Adapter\Phpunit\MockeryTestCase
{
    ...
    public function testAuthenticationExceptions()
    {
        ...
        $this->assertInstanceOf(\Facebook\Exceptions\FacebookAuthenticationException::class, $exception->getPrevious());
    ...
    public function testServerExceptions()
    {
        ...
        $exception = FacebookResponseException::create($response);
        $this->assertInstanceOf(\Facebook\Exceptions\FacebookServerException::class, $exception->getPrevious());
    ...
    public function testThrottleExceptions()
    {
        ...
        $response = new FacebookResponse($this->request, json_encode($params), 401);
        $exception = FacebookResponseException::create($response);
        $this->assertInstanceOf(\Facebook\Exceptions\FacebookThrottleException::class, $exception->getPrevious());
    ...
    public function testAuthorizationExceptions()
    {
        ...
        $response = new FacebookResponse($this->request, json_encode($params), 401);
        $exception = FacebookResponseException::create($response);
        $this->assertInstanceOf(\Facebook\Exceptions\FacebookAuthorizationException::class, $exception->getPrevious());
    ...
    public function testClientExceptions()
    {
        ...
        $response = new FacebookResponse($this->request, json_encode($params), 401);
        $exception = FacebookResponseException::create($response);
        $this->assertInstanceOf(\Facebook\Exceptions\FacebookClientException::class, $exception->getPrevious());
    ...
    public function testOtherException()
    {
        ...
        $exception = FacebookResponseException::create($response);
        $this->assertInstanceOf(\Facebook\Exceptions\FacebookOtherException::class, $exception->getPrevious());
